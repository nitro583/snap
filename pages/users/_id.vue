    ...
    <div class="">
        <div class="p-id__profile">
            <div class="p-id__profile__title">
                ...
                <button v-if="postUser[0].uid === user.uid" class="c-button" v-on:click="openModal">
              プロフィールを編集する
            </button>
            </div>
            <div class="p-id__profile__left">
                <div class="p-id__profile__image">
                    <img v-if="postUser[0].photoURL" :src="postUser[0].photoURL" :alt="userName" />
                    ...
                    <validation-observer v-slot="{ invalid, passes }">
                        ...
                        <form class="" @submit.prevent>
                            <div class="p-id__profile__edit__label-area">
                                <label class="p-id__profile__edit__label" for="name">User Name
                    </label>
                            </div>
                            <div class="p-id__profile__edit__input-area">
                                <validation-provider v-slot="{ errors }" rules="required|max:15" name="User Name">
                                    <input id="name" class="c-input p-id__profile__edit__input" type="text" v-model="userName" required />
                                    <p v-show="errors.length" class="p-id__profile__edit__error">
                                        {{ errors[0] }}
                                    </p>
                                </validation-provider>
                                <div class="p-id__profile__edit__label-area">
                                    <label class="p-id__profile__edit__label" for="introduction">introduction
                      </label>
                                </div>
                            </div>
                            <div class="p-id__profile__edit__input-area">
                                <validation-provider v-slot="{ errors }" rules="max:140" name="Introduction">
                                    <textarea rows="5" id="introduction" class="c-input p-id__profile__edit__text-area" type="text" v-model="introduction"></textarea>
                                    <p v-show="errors.length" class="p-id__profile__edit__error">
                                        {{ errors[0] }}
                                    </p>
                                </validation-provider>
                            ...
                            <div class="p-id__profile__edit__button-area">
                                ...
                                <button class="c-button p-id__profile__edit__button" type="submit" :disabled="invalid" @click="updateProfile">
                      変更する
                    </button>
                            </div>
                        </form>
